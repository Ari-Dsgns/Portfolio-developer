const translations={
    ...
    es: {
      ...
      aboutMeContent: "Hola, soy Ari, desarrollador front-end, diseñador web, diseñador UX/UI apasionado por el diseño, la simetría y las interfaces de usuario limpias. Creo que los diseños bien elaborados no solo proporcionan estabilidad visual, sino que también mejoran la experiencia del usuario de maneras sutiles y poderosas. A lo largo de los años, he encontrado un equilibrio único entre el diseño y el desarrollo, donde la creatividad y la lógica convergen. Es en ese punto medio donde me siento más a gusto, convirtiendo ideas en experiencias atractivas y funcionales para los usuarios. Para mí, los diseños son como seres vivos en la naturaleza: necesitan evolucionar y adaptarse a los entornos en los que existen. Creo que un diseño nunca está realmente terminado; debe crecer y transformarse junto con las personas que lo utilizan. Siempre estoy buscando oportunidades para crecer, colaborar con equipos inspiradores y crear productos que marquen la diferencia.",
